...
A two-rider, 1990s-style velodrome cycle trainer app racing game built with Python and Pygame. Rider speed is controlled entirely by live ANT+ power data, with optional ANT+ FE-C trainer resistance control.
